...
class ShopDB {
    ...
    getTargetCashiers1() {
        ...
        const sql = `SELECT Cashier.*, Address.* FROM Cashier, Address WHERE Cashier.addrID = Address.id AND Cashier.shopID IN (SELECT Shop.id FROM Shop, Address Where Shop.addrID = Address.id AND Address.City = '${models_1.City[models_1.City.Львов]}') AND Cashier.lastNet IN (${models_1.Net.Сiльпо} , ${models_1.Net.Арсен}) AND Cashier.startWork<='2016-01-01'`;
        console.log(sql);
